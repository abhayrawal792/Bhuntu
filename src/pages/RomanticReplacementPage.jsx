    ...
    <main className="min-h-[72dvh] bg-[#17131c] px-4 py-10 text-white sm:px-8 lg:px-16">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          ...
          <div className="relative grid grid-cols-2 gap-3"><img src={photos[0]} alt="A personal birthday memory" className="col-span-2 h-72 w-full rounded-[2rem] object-contain shadow-2xl" loading="lazy" /><img src={photos[1]} alt="Another shared memory" className="h-44 w-full rounded-[1.5rem] object-contain" loading="lazy" /><div className="flex h-44 flex-col justify-between rounded-[1.5rem] border border-white/10 bg-white/[.08] p-5"><Camera className="h-5 w-5 text-rose-200" /><p className="text-sm font-semibold leading-6 text-white/75">{item.memory}</p></div></div>
        </div>
