...
const lines = [
  'There was a day that did not know it was becoming important.',
  'There was a laugh that stayed longer than the conversation.',
  'There was a quiet walk that somehow made the whole week softer.',
  'There was you, turning a collection of minutes into a place to belong.',
];
    ...
    <main className="min-h-dvh bg-[#f5f1e9] text-[#24221e]">
      <section className="mx-auto grid min-h-dvh w-full max-w-6xl gap-10 px-5 py-10 sm:px-10 lg:grid-cols-[.7fr_1.3fr] lg:items-center lg:gap-20 lg:px-16">
        <aside className="flex flex-col justify-between gap-10 lg:min-h-[34rem]">
          <div><button type="button" onClick={() => navigate('/')} className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-[#766c5e] transition hover:text-[#24221e]"><ArrowLeft className="h-4 w-4" /> Doorway</button><div className="mt-12 h-px w-24 bg-[#24221e]" /><p className="mt-5 text-xs font-bold uppercase tracking-[0.28em] text-[#8a5b47]">Chapter three / the story room</p></div>
          <div><Feather className="h-8 w-8 text-[#8a5b47]" /><p className="mt-6 max-w-xs font-serif text-2xl leading-9 text-[#655b4e]">Some stories are built from plot. Ours is built from noticing.</p><div className="mt-8 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.18em] text-[#8a5b47]"><span className="h-2 w-2 rounded-full bg-[#8a5b47]" /> An unfolding letter, not a game</div></div>
        </aside>
        <div className="relative overflow-hidden border-y border-[#cfc4b4] py-12 sm:py-16">
          ...
          <p className="relative text-sm font-bold uppercase tracking-[0.25em] text-[#8a5b47]">A small archive of becoming us</p>
          <h1 className="relative mt-7 max-w-2xl font-serif text-5xl leading-[.96] tracking-[-0.05em] sm:text-7xl">The story is not what happened. It is what stayed.</h1>
          ...
          <div className="mt-14 flex items-center gap-3 text-xs font-bold uppercase tracking-[0.18em] text-[#8a5b47]"><ArrowDown className="h-4 w-4" /> Keep turning the page</div>
        </div>
      </section>
    </main>
  );
